...
public class EasyButton extends TextView {
    ...
    void init(AttributeSet attrs) {
        ...
        mTickColor = typeArray.getColor(com.spark.submitbutton.R.styleable.SubmitButton_sub_btn_tick_color,
                ContextCompat.getColor(getContext(), com.spark.submitbutton.R.color.white));
